...
/* src/Component.svelte generated by Svelte v3.46.4 */
...
function create_fragment(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					...
					listen(span, "change", /*change_handler*/ ctx[10])
				];
		...
		p(ctx, [dirty]) {
			if (dirty & /*counterResult*/ 2 && t_value !== (t_value = /*formatNumber*/ ctx[3](/*counterResult*/ ctx[1][/*id*/ ctx[2]]) + "")) set_data(t, t_value);
		},
		i: noop,
		o: noop,
		d(detaching) {
